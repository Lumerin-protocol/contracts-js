...
export declare type ImplementationEvents = 'Initialized' | 'cipherTextUpdated' | 'contractClosed' | 'contractPurchased' | 'destinationUpdated' | 'purchaseInfoUpdated';
