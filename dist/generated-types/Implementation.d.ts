...
export type ImplementationEvents = 'Initialized' | 'cipherTextUpdated' | 'closedEarly' | 'contractClosed' | 'contractPurchased' | 'destinationUpdated' | 'fundsClaimed' | 'purchaseInfoUpdated';
...
export type ImplementationMethodNames = 'buyer' | 'claimFunds' | 'cloneFactory' | 'closeEarly' | 'contractState' | 'contractTotal' | 'emptySlot1' | 'encrDestURL' | 'encrValidatorURL' | 'escrow_purchaser' | 'escrow_seller' | 'futureTerms' | 'getHistory' | 'getPublicVariables' | 'getPublicVariablesV2' | 'getStats' | 'history' | 'initialize' | 'isDeleted' | 'pubKey' | 'seller' | 'setContractCloseOut' | 'setContractDeleted' | 'setDestination' | 'setPurchaseContract' | 'setUpdateMiningInformation' | 'setUpdatePurchaseInformation' | 'startingBlockTimestamp' | 'terms' | 'validator';
...
export interface Implementation {
     ...
     * Type: function
     */
    emptySlot1(): MethodConstantReturnContext<string>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     * @param _validator Type: address, Indexed: false
     */
    setPurchaseContract(_encrValidatorURL: string, _encrDestURL: string, _buyer: string, _validator: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
