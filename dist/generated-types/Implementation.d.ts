...
export type ImplementationEvents = 'Initialized' | 'OwnershipTransferred' | 'Upgraded' | 'closedEarly' | 'contractPurchased' | 'destinationUpdated' | 'fundsClaimed' | 'purchaseInfoUpdated';
...
export interface Implementation {
     ...
     * Type: function
     */
    gap(): MethodConstantReturnContext<string>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    getHistory(_offset: string, _limit: string | number): MethodConstantReturnContext<HistoryentryResponse[]>;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
