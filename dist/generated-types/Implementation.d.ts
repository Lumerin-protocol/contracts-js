...
export type ImplementationEvents = 'Initialized' | 'closedEarly' | 'contractPurchased' | 'destinationUpdated' | 'fundsClaimed' | 'fundsClaimedValidator' | 'purchaseInfoUpdated';
...
export type ImplementationMethodNames = 'VALIDATOR_FEE_DECIMALS' | 'buyer' | 'claimFunds' | 'claimFundsValidator' | 'cloneFactory' | 'closeEarly' | 'contractState' | 'encrDestURL' | 'encrValidatorURL' | 'feeToken' | 'futureTerms' | 'getHistory' | 'getPublicVariablesV2' | 'getStats' | 'hashrateOracle' | 'history' | 'initialize' | 'isDeleted' | 'isLastValidatorNotPaid' | 'paymentToken' | 'priceAndFee' | 'pubKey' | 'seller' | 'setContractDeleted' | 'setDestination' | 'setPurchaseContract' | 'setUpdatePurchaseInformation' | 'startingBlockTimestamp' | 'terms' | 'validator' | 'validatorFeeRateScaled';
