...
export declare type CloneFactoryMethodNames = 'new' | 'checkWhitelist' | 'getContractList' | 'rentalContracts' | 'setAddToWhitelist' | 'setChangeNoMoreWhitelist' | 'setCreateNewRentalContract' | 'setPurchaseRentalContract' | 'setRemoveFromWhitelist' | 'whitelist';
...
export interface CloneFactory {
     ...
     * Type: function
     */
    setChangeNoMoreWhitelist(): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
