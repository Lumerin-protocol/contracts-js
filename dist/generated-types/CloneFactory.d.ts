...
export interface CloneFactory {
     ...
     * @param _profitTarget Type: int8, Indexed: false
     */
    setUpdateContractInformation(_contractAddress: string, _price: string, _limit: string, _speed: string, _length: string, _profitTarget: string | number): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
