...
export declare type CloneFactoryMethodNames = 'baseImplementation' | 'checkWhitelist' | 'getContractList' | 'initialize' | 'isContractDead' | 'marketplaceFee' | 'noMoreWhitelist' | 'owner' | 'payMarketplaceFee' | 'rentalContracts' | 'setAddToWhitelist' | 'setContractDeleted' | 'setCreateNewRentalContract' | 'setDisableWhitelist' | 'setMarketplaceFeeRecipient' | 'setPurchaseRentalContract' | 'setRemoveFromWhitelist' | 'setUpdateContractInformation' | 'whitelist';
...
export interface CloneFactory {
     ...
     */
    setPurchaseRentalContract(_contractAddress: string, _cipherText: string): MethodPayableReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
