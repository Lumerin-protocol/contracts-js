...
export type CloneFactoryEvents = 'Initialized' | 'OwnershipTransferred' | 'Upgraded' | 'clonefactoryContractPurchased' | 'contractCreated' | 'contractDeleteUpdated' | 'purchaseInfoUpdated';
