...
export declare type CloneFactoryEvents = 'clonefactoryContractPurchased' | 'contractCreated' | 'contractDeleteUpdated';
...
export declare type CloneFactoryMethodNames = 'new' | 'buyerFeeRate' | 'checkWhitelist' | 'getContractList' | 'noMoreWhitelist' | 'rentalContracts' | 'sellerFeeRate' | 'setAddToWhitelist' | 'setBaseImplementation' | 'setChangeBuyerFeeRate' | 'setChangeMarketplaceRecipient' | 'setChangeSellerFeeRate' | 'setContractDeleted' | 'setCreateNewRentalContract' | 'setDisableWhitelist' | 'setPurchaseRentalContract' | 'setRemoveFromWhitelist';
...
export interface CloneFactory {
     ...
     * StateMutability: nonpayable
     * Type: function
     * @param _newImplementation Type: address, Indexed: false
     */
    setBaseImplementation(_newImplementation: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
