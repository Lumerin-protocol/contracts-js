...
export type CloneFactoryMethodNames = 'UPGRADE_INTERFACE_VERSION' | 'VALIDATOR_FEE_DECIMALS' | 'VERSION' | 'baseImplementation' | 'feeToken' | 'getContractList' | 'getSellers' | 'hashrateOracle' | 'initialize' | 'isContractDead' | 'minSellerStake' | 'owner' | 'paymentToken' | 'proxiableUUID' | 'renounceOwnership' | 'rentalContracts' | 'sellerByAddress' | 'sellerDeregister' | 'sellerRegister' | 'setContractsDeleted' | 'setCreateNewRentalContractV2' | 'setMinSellerStake' | 'setPurchaseRentalContractV2' | 'setUpdateContractInformationV2' | 'setValidatorFeeRate' | 'transferOwnership' | 'upgradeToAndCall' | 'validatorFeeRateScaled';
...
export interface CloneFactory {
     ...
     */
    initialize(_baseImplementation: string, _hashrateOracle: string, _paymentToken: string, _feeToken: string, _validatorFeeRateScaled: string, _minSellerStake: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
