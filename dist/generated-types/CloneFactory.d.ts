...
export interface CloneFactory {
     ...
     */
    initialize(_baseImplementation: string, _lumerin: string, _feeRecipient: string, _validatorFeeRateScaled: string | number): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
     ...
     */
    setCreateNewRentalContract(_price: string, _limit: string, _speed: string, _length: string, parameter4: string, _pubKey: string): MethodPayableReturnContext;
    /**
     * Payable: true
     * Constant: false
     * StateMutability: payable
     ...
     * @param _pubKey Type: string, Indexed: false
     */
    setCreateNewRentalContractV2(_price: string, _limit: string, _speed: string, _length: string, _profitTarget: string | number, parameter5: string, _pubKey: string): MethodPayableReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * @param _validatorFeeRateScaled Type: uint16, Indexed: false
     */
    setValidatorFeeRate(_validatorFeeRateScaled: string | number): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
