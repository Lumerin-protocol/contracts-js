...
export interface ValidatorRegistry {
     ...
     */
    validatorRegister(stake: string, host: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: true
     * StateMutability: view
