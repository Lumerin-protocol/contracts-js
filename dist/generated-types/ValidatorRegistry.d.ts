...
export type ValidatorRegistryEvents = 'Initialized' | 'OwnershipTransferred' | 'Upgraded' | 'ValidatorComplain' | 'ValidatorDeregistered' | 'ValidatorPunished' | 'ValidatorRegisteredUpdated';
...
export type ValidatorRegistryMethodNames = 'new' | 'UPGRADE_INTERFACE_VERSION' | 'VERSION' | 'activeValidatorsLength' | 'forceUpdateActive' | 'getActiveValidators' | 'getValidator' | 'getValidatorV2' | 'getValidators' | 'initialize' | 'owner' | 'proxiableUUID' | 'punishAmount' | 'punishThreshold' | 'renounceOwnership' | 'setPunishAmount' | 'setPunishThreshold' | 'setStakeMinimum' | 'setStakeRegister' | 'stakeMinimum' | 'stakeRegister' | 'token' | 'totalStake' | 'transferOwnership' | 'upgradeToAndCall' | 'validatorComplain' | 'validatorDeregister' | 'validatorRegister' | 'validators' | 'validatorsLength' | 'withdraw';
