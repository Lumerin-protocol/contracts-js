...
export type ContractContext = Web3ContractContext<Lumerin, LumerinMethodNames, LumerinEventsContext, LumerinEvents>;
export type LumerinEvents = 'Approval' | 'OwnershipTransferred' | 'Paused' | 'Transfer' | 'Unpaused';
...
export type LumerinMethodNames = 'new' | 'allowance' | 'approve' | 'balanceOf' | 'burn' | 'burnFrom' | 'decimals' | 'decreaseAllowance' | 'increaseAllowance' | 'name' | 'owner' | 'pause' | 'paused' | 'renounceOwnership' | 'symbol' | 'totalSupply' | 'transfer' | 'transferFrom' | 'transferOwnership' | 'unpause';
