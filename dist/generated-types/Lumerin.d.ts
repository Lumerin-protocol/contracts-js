...
export declare type ContractContext = Web3ContractContext<Lumerin, LumerinMethodNames, LumerinEventsContext, LumerinEvents>;
export declare type LumerinEvents = 'Approval' | 'OwnershipTransferred' | 'Paused' | 'Transfer' | 'Unpaused';
export interface LumerinEventsContext {
    Approval(parameters: {
        filter?: {
            owner?: string | string[];
...
export declare type LumerinMethodNames = 'new' | 'allowance' | 'approve' | 'balanceOf' | 'burn' | 'burnFrom' | 'decimals' | 'decreaseAllowance' | 'increaseAllowance' | 'name' | 'owner' | 'pause' | 'paused' | 'renounceOwnership' | 'symbol' | 'totalSupply' | 'transfer' | 'transferFrom' | 'transferOwnership' | 'unpause';
