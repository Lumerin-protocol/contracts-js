...
export declare type FaucetMethodNames = 'new' | 'canClaimTokens' | 'cooldownPeriod' | 'cooldownStartingTime' | 'currentLMRTokenDistribution' | 'emptyGeth' | 'ethPayout' | 'lmrPayout' | 'lmrTokenDistributionMax' | 'resetDistributedTodayLmr' | 'setTransferLumerin' | 'setUpdateEthPayout' | 'setUpdateLmrPayout' | 'setUpdateLumerin' | 'setUpdateOwner' | 'setUpdatedailyMaxLmr' | 'supervisedClaim';
