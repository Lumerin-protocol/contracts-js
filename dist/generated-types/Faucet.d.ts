...
export declare type FaucetMethodNames = 'new' | 'canClaimTokens' | 'cooldownPeriod' | 'dailyLimitCount' | 'dailyLimitMax' | 'emptyGeth' | 'gethAmount' | 'resetTodaysLimit' | 'setTransferLumerin' | 'setUpdateCooldownPeriod' | 'setUpdateDailyLimit' | 'setUpdateGWEIAmount' | 'setUpdateLumerin' | 'setUpdateOwner' | 'setUpdateTxAmount' | 'startOfDay' | 'supervisedClaim' | 'txAmount';
export interface Faucet {
     ...
     * Type: function
     */
    dailyLimitMax(): MethodConstantReturnContext<string>;
    /**
     * Payable: false
     * Constant: false
     ...
     * Type: function
     */
    resetTodaysLimit(): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
     ...
     * StateMutability: nonpayable
     * Type: function
     * @param _dailyLimitMax Type: uint256, Indexed: false
     */
    setUpdateDailyLimit(_dailyLimitMax: string): MethodReturnContext;
    /**
     * Payable: false
     * Constant: false
     * StateMutability: nonpayable
